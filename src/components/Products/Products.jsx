...
const Products = () => {
  ...
  const nationalities = [
    "India", "Nepal", "Pakistan", "Sri Lanka", "Bangladesh", "Ghana", 
    "Saudi Arabia", "Afghanistan", "Kenya", "Bahrain", "China", 
    "Egypt", "Ethiopia", "Indonesia", "Macao", "Myanmar", 
    "Namibia", "Niger", "Nigeria", "Papua New Guinea", "Peru", 
    "Somalia", "Sudan", "South Sudan", "Syrian", "Turkey", 
    "Uganda", "Yemen", "Zimbabwe", "Zambia", "Uruguay", 
    "Suriname", "Slovakia", "Jordan", "Hong Kong",
  ];
    ...
    <div className="mx-4">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div>
          ...
          {/* Next Button */}
          <button
            className={`py-2 w-full my-5 rounded-md ${isFormComplete ? "bg-[#14B8A9] hover:bg-[#115752]" : "bg-[#ea3636] hover:bg-[#86291e]"} text-white duration-500`}
            onClick={handleNext}
